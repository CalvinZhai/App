...
export class WorkoutRunnerComponent implements OnInit, OnDestroy {
    ...
    restExercise: ExercisePlan;             // run this after each non-rest exercise
    currentExerciseIndex: number;
    currentExercise: ExercisePlan;          // track current exercise
    ...
    constructor(private router: Router, private tracker: WorkoutHistoryTracker) {   
        this.name = "WorkoutRunnerComponent";
    ...
    // triggered when navigating away from the component page
    ngOnDestroy() {
    ...
    // Lambda function, short-form representation of anonymous function
    ...
    buildWorkout(): WorkoutPlan {
        let workout = new WorkoutPlan("7MinWorkout", "7 Minute Workout", 5, []);
        ...
        workout.exercises.push(
            new ExercisePlan(
                new Exercise(
                    ...
                    "JumpingJacks.png",
                    "jumpingjacks.wav",
                    `Assume an erect position, with feet together and arms at your side. <br/><br/>
